...
final class PageRevisionHistoryTest extends TestCase {
 ...
 public function test_history_screen_is_available_to_administrators():void{$app=AppFactory::create(dirname(__DIR__),$this->path);$response=$app->handle((new ServerRequestFactory())->createServerRequest('GET','/admin/pages/page-welcome/history/pt'));self::assertSame(200,$response->getStatusCode());self::assertStringContainsString('Histórico de revisões',(string)$response->getBody());}
}
