...
final class Schema
{
    ...
    public static function seed(PDO $database): void
    {
        ...
        $models = [
            ...
            ['model-lesson', 'lesson', 'Aula', 'Conteúdo progressivo com explicação, exemplos e momentos de reforço.', [['heading','Etapa da aula',1],['text','Explicação',1],['code','Exemplo de código',0],['table','Tabela',0],['diagram','Diagrama',0],['image','Ilustração',0],['citation','Citação',0],['notice','Dica ou cuidado',0],['reference','Referência',0]]],
