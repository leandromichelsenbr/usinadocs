...
final class Schema
{
    ...
    public static function seed(PDO $database): void
    {
        ...
        $models = [
            ['model-reference', 'reference', 'Referência técnica', 'Sintaxe, explicação, exemplos e fontes para consulta rápida.', [['heading','Título de seção',0],['text','Texto',1],['code','Código',0],['table','Tabela',0],['image','Imagem',0],['reference','Referência',1],['citation','Citação',0],['notice','Aviso',0]]],
            ['model-article', 'article', 'Artigo', 'Leitura editorial com contexto, ilustrações, citações e referências.', [['heading','Título de seção',0],['text','Texto',1],['table','Tabela',0],['image','Imagem',0],['citation','Citação',0],['reference','Referência',1],['notice','Aviso',0]]],
            ['model-lesson', 'lesson', 'Aula', 'Conteúdo progressivo com explicação, exemplos e momentos de reforço.', [['heading','Etapa da aula',1],['text','Explicação',1],['code','Exemplo de código',0],['table','Tabela',0],['image','Ilustração',0],['citation','Citação',0],['notice','Dica ou cuidado',0],['reference','Referência',0]]],
